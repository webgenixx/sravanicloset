      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <div className="grid md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <div className="flex items-baseline gap-2">
              <span className="display-serif text-3xl tracking-wider">Sweety's</span>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-light">
              ...
              <li className="flex items-center gap-3 opacity-80"><Mail size={14} /> hello@sweetyscloset.com</li>
        ...
        <div className="mt-16 pt-8 border-t flex flex-col md:flex-row items-center justify-between gap-4"
          ...
          <p className="text-xs opacity-60 tracking-wider">
            © {new Date().getFullYear()} Sweety's Closet. Crafted with love.
          </p>
