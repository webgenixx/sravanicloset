...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Sravani Closet" },
      { property: "og:title", content: "Sravani Closet — Curated Indian Wear For Every Beautiful Woman" },
      ...
      { name: "twitter:title", content: "Sravani Closet — Curated Indian Wear For Every Beautiful Woman" },
